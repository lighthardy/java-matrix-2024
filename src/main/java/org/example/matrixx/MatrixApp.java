...
public class MatrixApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Отключение кнопок операций до загрузки матриц
    ...
    private HBox createFileSelectionBox() {
        ...
        loadMatrix1Button.setOnAction(e -> loadMatrix(1));
        loadMatrix2Button.setOnAction(e -> loadMatrix(2));
    ...
    /**
     * Загружает матрицу из файла и обновляет соответствующую область отображения.
     *
     * @param matrixNumber номер матрицы (1 или 2)
     */
    private void loadMatrix(int matrixNumber) {
